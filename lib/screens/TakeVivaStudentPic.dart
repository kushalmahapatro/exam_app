...
void main() {
  runApp(new TakeVivaStudentPic());
}

class TakeVivaStudentPic extends StatelessWidget {
  @override
...
//save the result of camera file
  ...
  Widget build(BuildContext context) {
    ...
    imageSelectorAdhaar() async {
      ...
      final File finalImage = await adhaarFile.copy('${knockDir.path}/viva_adhaar.png');
      print("path== " + path);
